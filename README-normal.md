...
> $$
> \begin{align}
> \frac{\partial L}{\partial \hat{y}_i} \cdot \frac{\partial \hat{y}_i}{\partial z_j} 
> &= \sum_{i=1} - \frac{y_i}{\hat{y_i}} \cdot \frac{\partial \hat{y}_i}{\partial z_j} \\
> &= (- \frac{y_i}{\hat{y_i}} \cdot \frac{\partial \hat{y}_i}
> {\partial z_j})_{i=j}+\sum_{i=1,i≠j}- \frac{y_i}{\hat{y_i}} \cdot \frac{\partial \hat{y}_i}{\partial z_j}  \\
> &=- \frac{y_i}{\hat{y_i}}\cdot\hat{y_i}\cdot(1-\hat{y_j})+\sum_{i=1,i≠j}- \frac{y_i}{\hat{y_i}} \cdot -\hat{y_i}\hat{y_j} \\ 
> &=-y_j+y_i\hat{y_j}+\sum_{i=1,i≠j}y_i\hat{y_j} \\ 
> &=-y_j+\hat{y_j}\sum_{i=1}y_i \\
> &=\hat{y_j}-y_j
> \end{align}
> $$
